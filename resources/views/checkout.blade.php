    ...
    <div class=" px-4 mt-8 sm:px-10">
        <div class="font-[sans-serif] bg-gray-50">
            <div class="grid lg:grid-cols-2 xl:grid-cols-3 gap-4 h-full">
                <div class="bg-primary-400 lg:h-screen lg:sticky lg:top-0">
                ...
                <div class="xl:col-span-2 h-max rounded-md p-8 sticky top-0">
                    ...
                    <form class="mt-10" action="/session" method="POST">
                            ...
                            <div class="grid sm:grid-cols-2 gap-6">
                                <div class="relative flex items-center">
                                    <input type="text" placeholder="First Name"
                                        class="px-4 py-3.5 bg-white text-primary-400 w-full text-sm border-b-2 focus:border-[#333] outline-none" />
                        ...
                        <div class="mt-6">
                            <h3 class="text-lg font-bold text-primary-400 mb-6">Shipping Address</h3>
                            <div class="grid sm:grid-cols-2 gap-6">
